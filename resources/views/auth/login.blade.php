...
<div class="container-fluid">
            <div class="row">
                    ...
                    <img src="{{url('asset/img/logo fessef.jpg')}}" width="500" height="200" style="margin-left: 70px">
                    <br>
                    <div style="margin-left: 70px;">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-10">
                                ...
                                <p  style="text-align: center;">vous n'avezpas de compte?<a href="{{route('register')}}">s'inscrire</a></p>
                            </div>
                        </div>
                    </form>
                    </div>
                    <div class="col-sm-9 col-md-6">
                        <img src="{{url('asset/img/connexion_image.jpg')}}" width="550" height="590">
                    </div>
                 </div>
                </div>
            </div>
