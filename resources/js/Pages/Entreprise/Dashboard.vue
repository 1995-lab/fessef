    ...
    <div>
        <div class="container">
            <div class="row">
                ...
                <div class="mb-2">
                    <form class="" action="">
                        <input class="form-control mb-1" type="search" placeholder="Faites vos recherches"
                            aria-label="Search" name="search">
                        <button class="btn btn-danger" type="submit">Faites vos recherches</button>
                    </form>
                </div>
    
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">Derniers Annonces postés</h5>
                    </div>
                </div>
